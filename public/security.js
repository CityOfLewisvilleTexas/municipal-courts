...
window.authenticate = function() {
    ...
    if (window.location.host === "apps") {
      ...
      if (
        ...
        oauthRedirectUrl =
          ...
          window.location.href
            ...
            .split(".")[0]
            .toLowerCase() +
          ".cityoflewisville.com/oauthredirect/index.html";
      } else {
        apiUrl = "https://ax1vnode1.cityoflewisville.com/";
        oauthRedirectUrl =
          "http://apps.cityoflewisville.com/oauthredirect/index.html";
      }
      ...
      function getNewColAuthToken(code) {
        var redirectUrl = window.location.href.substr(
          0,
      ...
      function getNewCode() {
        ...
        window.location =
          "https://accounts.google.com/o/oauth2/v2/auth?prompt=select_account&access_type=offline&scope=https://www.googleapis.com/auth/userinfo.email+https://www.googleapis.com/auth/userinfo.profile&response_type=code&redirect_uri=" +
          oauthRedirectUrl +
