<template>
    <v-container>
      <div class="py-3 text-xs-left">
            <h1 class="pt-3">How to Volunteer for Teen Court</h1>
            <v-container>
                <p>Students enrolled in Middle or High School who are under the age of 18, who attend school or reside in the greater Lewisville area are eligible to become volunteers in the Teen Court program. Potential volunteers attend volunteer training in spring or fall or attend a court session to observe courtroom proceedings. 

                <p>Upon completion of the application, students are asked to sign a Volunteer Agreement which details the responsibilities and expectations of the Teen Court program. Applications are available at the Teen Court office of the Lewisville Municipal Court building. Call the Teen Court office at 972.219.3671 to request an application or to find out the next court date.

                <p>Volunteer positions available at Teen Court are:  Juror, Bailiff, Court Clerk, Prosecutor, Defense Attorney, and Judge. 

                <p>Most volunteers begin by serving as a Juror and, if desired, can move on to other duties at their own pace.

                <p><b>NEXT Lewisville/Flower Mound Teen Court Info/Training Meeting Information:</b><br/>
                    <a href="https://www.cityoflewisville.com/home/showdocument?id=15176">Sept 11 TC Info Training</a>
                </p>
            </v-container>
                <h1 class="pt-3">Teen Court Volunteer Job Descriptions</h1>
                <v-container>
                    <p><b>JUROR</b><br/> 
