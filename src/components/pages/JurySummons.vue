...
                </p>
        ...
        <div class="py-3 text-xs-left" v-else>
            ...
            <v-container>
                ...
                <p>There is a penalty for jurors failing to respond to a summons. A juror may be fined up to $100 if he: 1) fails to attend court in disobedience to the notice without reasonable excuse; or 2) files a false claim of exemption from jury service.</p>

                <h2 class="mt-3">What Are The Different Types Of Cases? </h2>
                <p>There are two basic types of cases, criminal and civil (including family cases).</p> 
                ...
                <h2 class="mt-3">What Is Voir Dire Or Questioning Of The Jury Panel? </h2>
