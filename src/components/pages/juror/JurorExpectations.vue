...
      <h1 class="my-3">Servicio de jurado</h1>
      <h3> ¿Por qué es importante el servicio de jurado? </h3>
...
        <h3> ¿Cuál es mi deber como jurado? </h3>
...
        <p> No puede participar en un jurado si: </p>
        <ul>
...
        </ul>
        <h3> ¿Quién puede ser excusado del Servicio de Jurado? </h3>
        <br/>
        <p> Usted tiene derecho a ser excusado como miembro del jurado si:
        <ul>
...
            <li> Existe una sanción para los jurados que no responden a una citación. Un jurado puede recibir una multa de hasta $ 100 si: 1) no asiste a la corte en desobediencia al aviso sin una excusa razonable; o 2) presenta un reclamo falso de exención del servicio de jurado. </li>
        </ul>

        <h3> ¿Cuáles son los diferentes tipos de casos? </h3>
        Hay dos tipos básicos de casos, criminales y civiles (incluidos los casos familiares).
        <v-container>
            <h4> Casos penales: </h4>
...
        <h3> ¿Me pagarán por ser un miembro del jurado? </h3>
...
        <h3> ¿Mi empleador debe pagarme mientras estoy en servicio de jurado? </h3>
        <p> Su empleador no está obligado a pagarle mientras esté en servicio de jurado. Sin embargo, los empleadores tienen prohibido por ley despedir a un empleado por servir como miembro del jurado. Un empleado cuyo empleo termina en violación de esta sección tiene derecho a regresar al mismo empleo que tenía cuando fue convocado para un servicio de jurado si el empleado, tan pronto como sea práctico después de la liberación del servicio de jurado, le da al empleador un aviso real que el empleado pretende regresar. (Código de Práctica Civil y Recursos, art. 122.001). </p>
    <br/>
        <h3> ¿Quién puede tener un juicio con jurado? </h3>
...
        <h3> ¿Existen reglas sobre la conducta del jurado? </h3>
...
<h3> ¿Cómo se selecciona un jurado para un caso particular? </h3>
...
        Un jurado puede ser excusado del panel si se demuestra que el jurado no puede actuar imparcialmente con respecto al caso que se va a escuchar. Además, a cada lado se le permite eliminar un número determinado de jurados del panel sin tener que mostrar ninguna razón. El jurado de primera instancia será el primero de los 6 jurados restantes en el panel. </p>

        <h3> ¿Qué es Voir Dire o el cuestionamiento del jurado? </h3>
...
        Por ejemplo, el abogado puede hacerle preguntas para ver si está relacionado con el juicio o si tiene algún prejuicio o sesgo hacia alguien en el juicio. Estas preguntas no pretenden avergonzarlo, sino ayudar a los abogados en el proceso de selección del jurado. Puede pedirle al juez que le permita responder algunas preguntas lejos de los otros miembros del jurado. </p>

        <h3> ¿Qué sucede si tengo una necesidad especial o una emergencia? </h3>
...
    </div>
    <div v-else>
      <h1 class="my-3">Jury Service</h1>

        <h3>Why is Jury Service important?</h3> 
        <p>The United States Constitution and the Texas Constitution guarantee all people the right to trial by an impartial jury of their peers, regardless of race, religion, sex, national origin or economic status. </p>

        <h3>What is my duty as a Juror?</h3> 
        <p>As a juror, you must be fair and impartial. Your actions and decisions must also be free of any bias or prejudice because your actions and decisions are the foundation of our judicial system.</p> 

        <h3>How was I selected?</h3> 
        <p>You were selected at random from a list of voter registrations and a list of driver registrations from the county in which you live.</p>
        ...
        <p>You cannot serve on a jury if you:</p>
        <ul>
            <li>have been convicted of a felony or of any type of theft offense (unless your rights have been restored);</li>
            <li>are now on probation or deferred adjudication for a felony or for any type of theft; or</li>
            <li>are now under indictment for a felony or are now under criminal charges for any type of theft.</li>
            <li>If you are in doubt, or think you may not be qualified to serve on a jury for one of the above or any other reasons, please notify the Judge.</li>
        </ul>
        <br/>
        <h3>Who can be excused from Jury Service?</h3>
        <p>You are entitled to be excused as a juror if you:
        <ul>
            <li>are over 70 years of age;</li>
            <li>have legal custody of a child under 12 years of age and jury service would leave the child unsupervised;</li>
            <li>are a student in class;</li>
            <li>are the caretaker of a person who is unable to care for themselves (an invalid); or</li>
            <li>can show a physical or mental impairment or an inability to comprehend or to communicate in English.</li>
            <li>There is a penalty for jurors failing to respond to a summons. A juror may be fined up to $100 if he: 1) fails to attend court in disobedience to the notice without reasonable excuse; or 2) files a false claim of exemption from jury service.</li>
        </ul>

        <h3>What Are The Different Types Of Cases?</h3> 
        There are two basic types of cases, criminal and civil (including family cases). 
        <v-container>
            <h4>Criminal Cases:</h4> 
            <p>A criminal case results when a person is accused of committing a crime. You, as a Juror, must decide whether the person charged is guilty or not. The accused person is presumed innocent, and the State, represented by the city prosecutor, must prove the defendant is guilty "beyond a reasonable doubt."</p>
        
            <h4>Civil Cases:</h4> 
            <p>A civil case results from a disagreement or dispute between two or more private parties. In a civil case, you, as a juror, must answer questions of disputed facts based upon the testimony and evidence admitted by the Judge. The answers to these questions are called the verdict. Note: Municipal Court does not hear civil cases.</p>
        </v-container>

        <h3>Will I be paid for being a Juror?</h3> 
        <p>Yes. If you are selected to serve on the jury, you will be paid $10.00 for each day you actually serve. The Lewisville Teen Court solicits donations for their annual scholarship fund and you may, but are not obligated to, contribute your juror fee to this fund. For more information, please ask the bailiff or other court personnel.</p>

        <h3>Must my employer pay me while I am on Jury Duty?</h3> 
        <p>Your employer is not required to pay you while on jury duty. However, employers are prohibited by law from firing an employee for serving as a Juror. An employee whose employment is terminated in violation of this section is entitled to return to the same employment that was held when summoned for jury service if the employee, as soon as practical after release from jury service, gives the employer actual notice that the employee intends to return. (Civil Practice and Remedies Code, section 122.001). </p>

        <h3>Who Can Have A Jury Trial?</h3> 
        <p>Any person charged with a criminal offense or any party to a civil case has a right to a jury trial. All parties are equal before the law and each is entitled to the same fair treatment. </p>

        <h3>Are There Rules about Jury Conduct?</h3> 
        <p>Yes. The Texas Supreme Court has rules to assist you in your conduct as a Juror which will be given to you by the Judge.</p>
        
        <h3>How Is A Juror Selected For A Particular Case?</h3> 
        <p>Cases will be heard by juries of 6 jurors. A larger group, called a panel, will be sent to the trial court (courtroom) where the jurors will be questioned under the supervision of the Judge. 
        A juror may be excused from the panel if it is shown that the juror cannot act impartially concerning the case to be heard. In addition, each side is allowed to remove a given number of jurors from the panel without having to show any reason. The trial jury will be the first 6 of the remaining jurors on the panel. </p>

        <h3>What Is Voir Dire Or Questioning Of The Jury Panel?</h3> 
        <p>It is a way for the parties to select a fair and impartial jury. Under the justice system, you may be questioned by each of the lawyers before they decide to remove a certain number of jurors from the jury panel. 
        For example, the lawyer may ask you questions to see if you are connected to the trial or if you have any prejudice or bias toward anyone in the trial. These questions are not intended to embarrass you, but rather to help the lawyers in the jury selection process. You may ask the judge to allow you to answer some questions away from the other jurors. </p>

        <h3>What If I Have A Special Need or Emergency?</h3> 
        <p>After you have been selected as a juror on a trial panel, if you have a special need or an emergency, tell the bailiff. </p>
        <h3>How Do We Act During the Trial?</h3> 
        <p>
